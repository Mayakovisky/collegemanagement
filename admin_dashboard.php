...
<body>
    ...
    <div class="search-box">
        <form action="search_student.php" method="POST">
            <input type="text" name="search_query" placeholder="registration_number" required>
    ...
    <table border="1" cellspacing="0" cellpadding="10" style="width: 100%; text-align: left;">
        ...
        if ($result && $result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='#'>Edit</a> <a href='#'>Suspend</a> <a href='delete_student.php?id=" . htmlspecialchars($row['student_id']) . "' onclick='return confirm(\"Are you sure you want to delete this record?\");'>Delete</a></td>";
                echo "</tr>";
